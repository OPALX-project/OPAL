...
U1: UNDULATOR, L = 9.0, Z = 1.5, K = 1.417, LAMBDA = .03, FNAME = "reduced.job";

GS:  Line = (GUN, BF, M);

DRIVE: Line = (GS, DR1, U1);

Dist: DISTRIBUTION, TYPE = FLATTOP,        SIGMAX = 0.00075,        SIGMAY = 0.00075,        TRISE = 6.0e-12,               TFALL = 6.0e-12,               TPULSEFWHM = 20.0e-12,         CUTOFFLONG = 4.0,        NBIN = 5,        EMISSIONSTEPS = 100,        EMISSIONMODEL = ASTRA,        EKIN = 0.55,                   EMITTED = True,                WRITETOFILE = False;
