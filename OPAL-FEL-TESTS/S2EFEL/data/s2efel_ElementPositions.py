...
vertices = []
numVertices = [74, 74, 74, 74]
vertices_base64 = ""
...
decoration = [[ 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.292707], [ 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.500000], [ 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.500000], [ 0.000000, 0.000000, 0.500000, 0.000000, 0.000000, 10.500000]]
...
def exportVTK():
    ...
    fh = open('s2efel_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('s2efel_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('s2efel_ElementPositions.gpl','w')
