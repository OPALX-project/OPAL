...
REAL rf_freq             = 1.0;
     REAL n_particles         = 1.846e08;
      REAL beam_bunch_charge   =  1.6e-19 * 1e6 * 1.846e08;
...
UND: UNDULATOR, L = 10.0, LFRINGE = 1.0, Z = 0.5, K = 1.417, LAMBDA = .03,      MESHLENGTH = { 3.2e-3, 3.2e-3, .28e-3 }, MESHRESOLUTION = {50e-6, 50e-6, .1e-6},     TRUNORDER = 2, SPACECHARGE = 0,     FNAME = "undulator_output.job", TIMESTEPRATIO = 2;
