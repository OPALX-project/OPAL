...
class VerticalFFAMagnet : public Component {
  public:
    ...
    /** Calculate the four-potential at some arbitrary position
     *
     *  \param R position in the local coordinate system of the magnet
     *  \param t time (not used)
     *  \param A calculated magnetic vector potential
     *  \param phi calculated electric potential (always 0)
     *  \returns true if particle is outside the field map, else false
     */
    inline bool getPotential(
               const Vector_t &R, const double &t,
