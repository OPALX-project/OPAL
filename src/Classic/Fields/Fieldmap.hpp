...
template<class T>
bool Fieldmap::interpretLine(std::ifstream & in, T & value, const bool & file_length_known) const
{
    bool read_all = true;
    std::string buffer;
...
bool Fieldmap::interpretLine(std::ifstream & in, S & value1, T & value2, const bool & file_length_known) const
{
    bool read_all = true;
    std::string buffer;
    std::streampos start = in.tellg();
...
bool Fieldmap::interpretLine(std::ifstream & in, S & value1, T & value2, U & value3, const bool & file_length_known) const
{
    bool read_all = true;
    std::string buffer;
    std::streampos start = in.tellg();
...
bool Fieldmap::interpretLine(std::ifstream & in, S & value1, T & value2, U & value3, V & value4, const bool & file_length_known) const
{
    bool read_all = true;
    std::string buffer;
    std::streampos start = in.tellg();
...
template<class S>
bool Fieldmap::interpretLine(std::ifstream & in, S & value1, S & value2, S & value3, S & value4, S & value5, S & value6, const bool & file_length_known) const
{
    bool read_all = true;
    std::string buffer;
    std::streampos start = in.tellg();
