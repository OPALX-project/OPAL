...
const std::string OpalVerticalFFAMagnet::docstring_m =
...
OpalVerticalFFAMagnet::OpalVerticalFFAMagnet() :
    ...
    itsAttr[FIELD_INDEX] = Attributes::makeReal
        ("FIELD_INDEX", "Exponent term in the field index [m^(-1)].");

    itsAttr[WIDTH] = Attributes::makeReal
        ("WIDTH",
         "The full width of the magnet. Particles moving more than WIDTH/2 horizontally, "
         "in either direction, are out of the aperture.");
    ...
    itsAttr[END_LENGTH] = Attributes::makeReal
        ("END_LENGTH", "The end length of the FFA fringe field [m].");
    ...
    itsAttr[BB_LENGTH] = Attributes::makeReal
        ("BB_LENGTH",
         "Determines the length of the bounding box. Magnet is situated "
         "symmetrically in the bounding box. [m]");

    itsAttr[HEIGHT_POS_EXTENT] = Attributes::makeReal
        ("HEIGHT_POS_EXTENT",
         "Height of the magnet above z=0. Particles moving upwards more than "
         "HEIGHT_POS_EXTENT are out of the aperture [m].");

    itsAttr[HEIGHT_NEG_EXTENT] = Attributes::makeReal
        ("HEIGHT_NEG_EXTENT",
         "Height of the magnet below z=0. Particles moving downwards more than "
         "HEIGHT_NEG_EXTENT are out of the aperture [m].");
...
void OpalVerticalFFAMagnet::update() {
    ...
    int maxOrder = std::floor(Attributes::getReal(itsAttr[MAX_HORIZONTAL_POWER]));
